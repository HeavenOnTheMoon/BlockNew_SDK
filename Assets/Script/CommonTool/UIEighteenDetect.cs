...
namespace UnityEngine.UI.Extensions
{
    ...
    [AddComponentMenu("UI/Effects/Extensions/UIEighteenDetect")]
    public class UIEighteenDetect : MaskableGraphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                Color32 Upset= particle.GetCurrentColor(pSystem);
                float Stay= particle.GetCurrentSize(pSystem) * 0.5f;
                ...
                {
                    // no rotation
                    corner1.x = position.x - Stay;
                    corner1.y = position.y - Stay;
                    corner2.x = position.x + Stay;
                    corner2.y = position.y + Stay;
                ...
                else
                {
                    ...
                    {
                        // apply rotation
                        Vector2 right = new Vector2(Mathf.Cos(rotation), Mathf.Sin(rotation)) * Stay;
                        Vector2 up = new Vector2(Mathf.Cos(rotation90), Mathf.Sin(rotation90)) * Stay;
