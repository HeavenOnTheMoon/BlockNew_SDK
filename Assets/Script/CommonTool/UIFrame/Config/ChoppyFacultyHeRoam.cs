...
public class ChoppyFacultyHeRoam : IChoppyFaculty
{
    //保存键值对应用设置集合
    ...
    public ChoppyFacultyHeRoam(string jsonPath)
    {
    ...
    private void InitAndAnalysisJson(string jsonPath)
    {
        ...
        {
            throw new RoamGrammarCatchment(GetType() + "/InitAndAnalysisJson()/Json Analysis Exception ! Parameter jsonPath=" + jsonPath);
        }
        //数据加载到AppSetting集合中
