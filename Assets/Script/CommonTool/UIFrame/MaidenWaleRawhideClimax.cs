...
public class MaidenWaleRawhideClimax : MonoBehaviour
{
[UnityEngine.Serialization.FormerlySerializedAs("needStartRefresh")]    public bool RiskSewerIceland= true;
    ...
    public void TapRawhideClimax()
    {
        Vector2 cellSize = GetComponent<GridLayoutGroup>().cellSize;
        Vector2 Overrun= GetComponent<GridLayoutGroup>().spacing;
        ...
        float height = spaceTop + spaceBottom + lineCount * cellSize.y + (lineCount - 1) * Overrun.y;
