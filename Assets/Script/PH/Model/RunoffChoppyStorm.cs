...
/// 服务器配置
/// </summary>
public class RunoffChoppyStorm
{
    ...
    public RunoffChoppyStorm() { }

    public RunoffChoppyStorm(List<HttpReponseServerConfigModelItem> list)
    {
    ...
    private JsonData GetConfigByLanguage(string jsonStr)
    {
        ...
        string language = NativePeat.Equality.HisEfficacy();
